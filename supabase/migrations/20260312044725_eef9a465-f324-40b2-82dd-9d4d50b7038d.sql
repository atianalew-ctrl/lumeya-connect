...
CREATE POLICY "Public profiles are viewable" ON public.profiles FOR SELECT TO anon USING (true);
...
BEGIN
  ...
  VALUES (NEW.id, _role, COALESCE(NEW.raw_user_meta_data->>'full_name', ''));
