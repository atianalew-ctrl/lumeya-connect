...
export const creators: Creator[] = [
  ...
  { id: 6, name: "Celina Beck", role: "Copywriter", location: "Austin, TX", country: "United States", region: "North America", languages: ["English"], timezone: "CST", availableForRemote: true, rating: 4.6, tags: ["Email", "Web Copy", "Ads"], bio: "Words that sell. Conversion-focused copy for modern brands. Specializing in email sequences, landing pages, and ad copy that drives action.", portfolio: 20, rates: "$200–$600 per piece", skills: ["Writing", "Social Media", "Email Marketing"], color: "from-yellow-200 to-amber-200", brands: ["PureBlend", "GlowCo"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4", avatar: "/lovable-uploads/celina-beck-avatar.png", contentTypes: ["Voiceover / B-roll", "Testimonial"], instagram: "celinabeck" },
