export const creators = [
  { id: 1, name: "Mia Chen", role: "UGC Creator", location: "Los Angeles, CA", rating: 4.9, tags: ["Lifestyle", "Fashion", "Beauty"], bio: "Creating authentic content that converts. 3+ years of UGC experience with top DTC brands. Specializing in lifestyle and beauty content that feels real and relatable.", portfolio: 24, rates: "$200–$500 per video", skills: ["UGC", "TikTok", "Photography", "Social Media", "Video Editing"], color: "from-pink-300 to-rose-200", brands: ["GlowCo", "LuxeBeauty", "FreshFace"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4" },
  ...
  { id: 3, name: "Aisha Koroma", role: "Social Media Manager", location: "London, UK", rating: 5.0, tags: ["TikTok", "Reels", "Strategy"], bio: "Growing brands through viral short-form content and strategy. Managed accounts with 500K+ combined followers across TikTok and Instagram.", portfolio: 15, rates: "$1,500–$3,000/mo", skills: ["Social Media", "TikTok", "Instagram", "Strategy", "Video Editing"], color: "from-emerald-200 to-teal-200", brands: ["FitPulse", "TechNova", "Wanderlust"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4" },
  { id: 4, name: "Leo Martinez", role: "Videographer", location: "Miami, FL", rating: 4.7, tags: ["Brand Films", "Ads", "Documentary"], bio: "Cinematic storytelling for brands that want to stand out. From concept to final cut, I craft films that move people and drive results.", portfolio: 32, rates: "$1,000–$5,000 per project", skills: ["Videography", "Photography", "YouTube", "Video Editing"], color: "from-cyan-200 to-blue-200", brands: ["Wanderlust Travel", "Nike Local", "RedBull"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4" },
  { id: 5, name: "Priya Sharma", role: "Graphic Designer", location: "Toronto, CA", rating: 4.9, tags: ["Branding", "Social Media", "Illustration"], bio: "Crafting visual identities that resonate with your audience. From logo design to full brand systems, I help brands look their best.", portfolio: 56, rates: "$500–$2,000 per project", skills: ["Design", "Social Media", "Photography", "Illustration"], color: "from-violet-200 to-indigo-200", brands: ["TechNova", "Nourish", "PureBlend"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4" },
  { id: 6, name: "Marcus Johnson", role: "Copywriter", location: "Austin, TX", rating: 4.6, tags: ["Email", "Web Copy", "Ads"], bio: "Words that sell. Conversion-focused copy for modern brands. Specializing in email sequences, landing pages, and ad copy that drives action.", portfolio: 20, rates: "$200–$600 per piece", skills: ["Writing", "Social Media", "Email Marketing"], color: "from-yellow-200 to-amber-200", brands: ["PureBlend", "GlowCo"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4" },
  ...
  { id: 8, name: "Daniel Osei", role: "Motion Designer", location: "Berlin, DE", rating: 4.9, tags: ["Animation", "Motion Graphics", "3D"], bio: "Bringing brands to life with dynamic motion design. From social media animations to full brand videos, I make things move.", portfolio: 28, rates: "$800–$3,000 per project", skills: ["Design", "Videography", "Social Media", "3D Animation"], color: "from-sky-200 to-cyan-200", brands: ["TechNova", "FitPulse", "Wanderlust"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4" },
];
