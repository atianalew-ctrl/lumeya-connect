...
export const creators: Creator[] = [
  ...
  { id: 5, name: "Celina Beck", role: "UGC Creator", location: "Bali / Dubai", country: "Global", region: "Global", languages: ["English", "Vietnamese", "Indonesian"], timezone: "WITA", availableForRemote: true, rating: 4.9, tags: ["Branding", "Social Media", "Illustration"], bio: "minimalistic vibe, specialized in voice overs, food & fashion\n", portfolio: 56, rates: "$500–$2,000 per project", skills: ["Design", "Social Media", "Photography", "Illustration"], color: "from-violet-200 to-indigo-200", brands: ["TechNova", "Nourish", "PureBlend"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4", avatar: "/lovable-uploads/59419297-8971-48c3-a2c5-2b636c4b1db6.png", contentTypes: ["Unboxing", "Lifestyle Content", "Product Review"], instagram: "celinabeck" },
