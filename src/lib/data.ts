...
export const creators: Creator[] = [
  ...
  { id: 2, name: "Nikoline Amelia ", role: "UGC Creator", location: "France", country: "France", region: "Europe", languages: ["English", "French"], timezone: "CET", availableForRemote: true, rating: 4.8, tags: ["Product", "Food", "Flat Lay"], bio: "Scandinavian minimalistic vibe, specialised in lifestyle and beauty brands\n", portfolio: 48, rates: "$300–$800 per shoot", skills: ["Photography", "Design", "Social Media", "Product Videos"], color: "from-amber-200 to-orange-200", brands: ["Brew & Co.", "FarmTable", "UrbanBite"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4", avatar: "/lovable-uploads/cd5a920c-8cf1-4735-9844-a67d2c7e4d28.png", contentTypes: ["Product Demo", "Unboxing", "Voiceover / B-roll"], instagram: "jordanblake" },
  { id: 3, name: "Sussie Agger", role: "Content Creator", location: "Copenhagen, Denmark", country: "Denmark", region: "Scandinavia", languages: ["English", "Polish", "Indonesian"], timezone: "WITA", availableForRemote: true, rating: 5.0, tags: ["TikTok", "Reels", "Strategy"], bio: "Scandinavian minimalistic vibe, specialised in lifestyle and beauty brands\n", portfolio: 15, rates: "$1,500–$3,000/mo", skills: ["Social Media", "TikTok", "Instagram", "Strategy", "Video Editing"], color: "from-emerald-200 to-teal-200", brands: ["FitPulse", "TechNova", "Wanderlust"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4", avatar: "/lovable-uploads/ff812edb-72d9-419a-809e-81d311763fdb.jpg", contentTypes: ["Voiceover / B-roll", "Lifestyle Content", "Vlog / Day-in-the-life", "TikTok Trend / Social Trend"], instagram: "sussieagger" },
  { id: 4, name: "Amalie Asheim", role: "UGC Creatot", location: "Miami, FL", country: "United States", region: "North America", languages: ["English", "Spanish"], timezone: "EST", availableForRemote: false, rating: 4.7, tags: ["Brand Films", "Ads", "Documentary"], bio: "Cinematic storytelling for brands that want to stand out. From concept to final cut, I craft films that move people and drive results.", portfolio: 32, rates: "$1,000–$5,000 per project", skills: ["Videography", "Photography", "YouTube", "Video Editing"], color: "from-cyan-200 to-blue-200", brands: ["Wanderlust Travel", "Nike Local", "RedBull"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4", avatar: "/lovable-uploads/b0a2c103-a2be-4f3e-8785-4b072d9f90cf.png", contentTypes: ["Problem → Solution Ad", "Product Demo", "Testimonial"], instagram: "leomartinez" },
  { id: 5, name: "Nella Ryglova", role: "UGC Creator", location: "Bali / Dubai", country: "Global", region: "Global", languages: ["English", "Vietnamese", "Indonesian"], timezone: "WITA", availableForRemote: true, rating: 4.9, tags: ["Branding", "Social Media", "Illustration"], bio: "minimalistic vibe, specialized in voice overs, food & fashion\n", portfolio: 56, rates: "$500–$2,000 per project", skills: ["Design", "Social Media", "Photography", "Illustration"], color: "from-violet-200 to-indigo-200", brands: ["TechNova", "Nourish", "PureBlend"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4", avatar: "/lovable-uploads/59419297-8971-48c3-a2c5-2b636c4b1db6.png", contentTypes: ["Unboxing", "Lifestyle Content", "Product Review"], instagram: "nellaryglova" },
  { id: 6, name: "Celina Beck", role: "Copywriter", location: "Austin, TX", country: "United States", region: "North America", languages: ["English"], timezone: "CST", availableForRemote: true, rating: 4.6, tags: ["Email", "Web Copy", "Ads"], bio: "Words that sell. Conversion-focused copy for modern brands. Specializing in email sequences, landing pages, and ad copy that drives action.", portfolio: 20, rates: "$200–$600 per piece", skills: ["Writing", "Social Media", "Email Marketing"], color: "from-yellow-200 to-amber-200", brands: ["PureBlend", "GlowCo"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4", avatar: "/lovable-uploads/586b6ac2-ac5d-4fe8-bd61-5fe0cea916b0.png", contentTypes: ["Voiceover / B-roll", "Testimonial"], instagram: "celinabeck" },
  { id: 7, name: "Sakura Tanaka", role: "Influencer", location: "Tokyo, JP", country: "Japan", region: "Asia Pacific", languages: ["Japanese", "English"], timezone: "JST", availableForRemote: true, rating: 4.8, tags: ["Beauty", "Skincare", "Wellness"], bio: "150K+ followers. Authentic reviews and sponsored content that my audience trusts. Focused on beauty, skincare, and wellness brands.", portfolio: 40, rates: "$500–$2,000 per post", skills: ["Instagram", "TikTok", "UGC", "Photography"], color: "from-rose-200 to-pink-200", brands: ["GlowCo", "FreshFace", "WellnessPlus"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/SubaruOutbackOnStreetAndDirt.mp4", avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Sakura", contentTypes: ["Product Review", "Unboxing", "TikTok Trend / Social Trend", "Vlog / Day-in-the-life"], instagram: "sakuratanaka" },
  { id: 8, name: "Daniel Osei", role: "Motion Designer", location: "Berlin, DE", country: "Germany", region: "Europe", languages: ["English", "German", "French"], timezone: "CET", availableForRemote: true, rating: 4.9, tags: ["Animation", "Motion Graphics", "3D"], bio: "Bringing brands to life with dynamic motion design. From social media animations to full brand videos, I make things move.", portfolio: 28, rates: "$800–$3,000 per project", skills: ["Design", "Videography", "Social Media", "3D Animation"], color: "from-sky-200 to-cyan-200", brands: ["TechNova", "FitPulse", "Wanderlust"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4", avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Daniel", contentTypes: ["Problem → Solution Ad", "Product Demo", "Voiceover / B-roll"], instagram: "danielosei" },
];
