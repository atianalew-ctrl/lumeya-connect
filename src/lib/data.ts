export const creators = [
  { id: 1, name: "Mia Chen", role: "UGC Creator", location: "Los Angeles, CA", rating: 4.9, tags: ["Lifestyle", "Fashion", "Beauty"], bio: "Creating authentic content that converts. 3+ years of UGC experience with top DTC brands. Specializing in lifestyle and beauty content that feels real and relatable.", portfolio: 24, rates: "$200–$500 per video", skills: ["UGC", "TikTok", "Photography", "Social Media", "Video Editing"], color: "from-pink-300 to-rose-200", brands: ["GlowCo", "LuxeBeauty", "FreshFace"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4", avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Mia" },
