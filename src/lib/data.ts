...
export const creators: Creator[] = [
  ...
  { id: 5, name: "Celina Beck", role: "UGC Creator", location: "Canggu, Bali", country: "Indonesia", region: "Southeast Asia", languages: ["English", "Vietnamese", "Indonesian"], timezone: "WITA", availableForRemote: true, rating: 4.9, tags: ["Branding", "Social Media", "Illustration"], bio: "Crafting visual identities that resonate with your audience. From logo design to full brand systems, I help brands look their best.", portfolio: 56, rates: "$500–$2,000 per project", skills: ["Design", "Social Media", "Photography", "Illustration"], color: "from-violet-200 to-indigo-200", brands: ["TechNova", "Nourish", "PureBlend"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4", avatar: "/lovable-uploads/59419297-8971-48c3-a2c5-2b636c4b1db6.png", contentTypes: ["Unboxing", "Lifestyle Content", "Product Review"], instagram: "nataliamai" },
