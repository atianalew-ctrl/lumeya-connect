export type Region = "Europe" | "North America" | "Asia Pacific" | "Southeast Asia" | "Middle East" | "Latin America" | "Africa";
...
export const creators: Creator[] = [
  { id: 1, name: "Sara Lee", role: "UGC Creator", location: "Copenhagen, DK", country: "Denmark", region: "Europe", languages: ["English", "Danish"], timezone: "CET", availableForRemote: true, rating: 4.9, tags: ["Lifestyle", "Fashion", "Beauty"], bio: "Creating authentic content that converts. 3+ years of UGC experience with top DTC brands. Specializing in lifestyle and beauty content that feels real and relatable.", portfolio: 24, rates: "$200–$500 per video", skills: ["UGC", "TikTok", "Photography", "Social Media", "Video Editing"], color: "from-pink-300 to-rose-200", brands: ["GlowCo", "LuxeBeauty", "FreshFace"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4", avatar: "/lovable-uploads/45d7dcc1-eb95-4a25-b50d-87bc5730e1c5.jpg" },
  { id: 2, name: "Jordan Blake", role: "Photographer", location: "New York, NY", country: "United States", region: "North America", languages: ["English"], timezone: "EST", availableForRemote: true, rating: 4.8, tags: ["Product", "Food", "Flat Lay"], bio: "Specializing in product photography that tells your brand story. Working with food, lifestyle, and e-commerce brands to create scroll-stopping visuals.", portfolio: 48, rates: "$300–$800 per shoot", skills: ["Photography", "Design", "Social Media", "Product Videos"], color: "from-amber-200 to-orange-200", brands: ["Brew & Co.", "FarmTable", "UrbanBite"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4", avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Jordan" },
  { id: 3, name: "Amelia Kozak", role: "Content Creator", location: "Bali, ID", country: "Indonesia", region: "Southeast Asia", languages: ["English", "Polish", "Indonesian"], timezone: "WITA", availableForRemote: true, rating: 5.0, tags: ["TikTok", "Reels", "Strategy"], bio: "Scandinavian minimalistic vibe, specialized in voice overs, food & fashion", portfolio: 15, rates: "$1,500–$3,000/mo", skills: ["Social Media", "TikTok", "Instagram", "Strategy", "Video Editing"], color: "from-emerald-200 to-teal-200", brands: ["FitPulse", "TechNova", "Wanderlust"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4", avatar: "/lovable-uploads/23b97164-8b1e-40d0-a9c4-fc5686f28068.jpg" },
  { id: 4, name: "Leo Martinez", role: "Videographer", location: "Miami, FL", country: "United States", region: "North America", languages: ["English", "Spanish"], timezone: "EST", availableForRemote: false, rating: 4.7, tags: ["Brand Films", "Ads", "Documentary"], bio: "Cinematic storytelling for brands that want to stand out. From concept to final cut, I craft films that move people and drive results.", portfolio: 32, rates: "$1,000–$5,000 per project", skills: ["Videography", "Photography", "YouTube", "Video Editing"], color: "from-cyan-200 to-blue-200", brands: ["Wanderlust Travel", "Nike Local", "RedBull"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4", avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Leo" },
  { id: 5, name: "Natalia Mai", role: "UGC Creator", location: "Canggu, Bali", country: "Indonesia", region: "Southeast Asia", languages: ["English", "Vietnamese", "Indonesian"], timezone: "WITA", availableForRemote: true, rating: 4.9, tags: ["Branding", "Social Media", "Illustration"], bio: "Crafting visual identities that resonate with your audience. From logo design to full brand systems, I help brands look their best.", portfolio: 56, rates: "$500–$2,000 per project", skills: ["Design", "Social Media", "Photography", "Illustration"], color: "from-violet-200 to-indigo-200", brands: ["TechNova", "Nourish", "PureBlend"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4", avatar: "/lovable-uploads/ca56b912-7edc-40a0-9611-c29da383fee8.jpg" },
