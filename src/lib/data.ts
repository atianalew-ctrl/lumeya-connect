...
export const creators: Creator[] = [
  ...
  { id: 4, name: "Leo Martinez", role: "Videographer", location: "Miami, FL", country: "United States", region: "North America", languages: ["English", "Spanish"], timezone: "EST", availableForRemote: false, rating: 4.7, tags: ["Brand Films", "Ads", "Documentary"], bio: "Cinematic storytelling for brands that want to stand out. From concept to final cut, I craft films that move people and drive results.", portfolio: 32, rates: "$1,000–$5,000 per project", skills: ["Videography", "Photography", "YouTube", "Video Editing"], color: "from-cyan-200 to-blue-200", brands: ["Wanderlust Travel", "Nike Local", "RedBull"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4", avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Leo", contentTypes: ["Problem → Solution Ad", "Product Demo", "Testimonial"], instagram: "leomartinez" },
